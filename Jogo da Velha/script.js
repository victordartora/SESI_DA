const btn1_vrl = document.getElementById("1").innerHTML;
const btn2_vrl = document.getElementById("2").innerHTML;
const btn3_vrl = document.getElementById("3").innerHTML;
const btn4_vrl = document.getElementById("4").innerHTML;
const btn5_vrl = document.getElementById("5").innerHTML;
const btn6_vrl = document.getElementById("6").innerHTML;
const btn7_vrl = document.getElementById("7").innerHTML;
const btn8_vrl = document.getElementById("8").innerHTML;
const btn9_vrl = document.getElementById("9").innerHTML;
...
function contabilizadorGanhadores(){
    ...
    if(ordem_jogada == true){
     ...
     document.getElementById("total_o").innerHTML = "Total de vitorias O: " + total_de_jogadas;
     document.getElementById("total_x").innerHTML = "Total de vitorias X: " + total_de_jogadas;
}